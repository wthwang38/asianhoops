...
function Footer() {
  return (
    <footer className="text-center lg:text-left bg-gray-100">
      {/* <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300"></div> */}
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p>
              AsianHoops is a platform where you can stay up to date on the latest league games and 
              ballers of all ages can sign up to compete against to showcase their skills! #BallIsLife 
            </p>
          </div>
          <div>
            ...
            <p>
              <button className="border-red-600 bg-orange-400 text-blue-600 font-bold">Sponsor Us</button>
            </p>
          </div>
          <div>
            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start text-red-600">
      ...
      <div className="text-center p-6 bg-gray-200">
        <span>© 2023 Copyright AsianHoops</span>
      </div>
    </footer>
  )
}
